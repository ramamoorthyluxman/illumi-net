...
def calculate_and_adjust_patches(image_width, image_height, patch_width, patch_height):
    ...
    return adjusted_patch_width, adjusted_patch_height, patches_y, total_patches
    
    return {
        "patches_x": patches_x,
        "patches_y": patches_y,
        "total_patches": total_patches,
        "adjusted_patch_width": adjusted_patch_width,
        "adjusted_patch_height": adjusted_patch_height
    }
